 ...
 * Use the [ZeeNewsFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class ZeeNewsFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val view:View= inflater.inflate(R.layout.fragment_zee_news, container, false)

        //to use channel link as webview in app
        val web=view.findViewById<WebView>(R.id.webView5)
        web.loadUrl("https://zeenews.india.com/")
